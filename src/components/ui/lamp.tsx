...
export function LampBeam({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-x-0 top-[7px] flex h-[18rem] scale-y-125 items-center justify-center isolate z-0 [-webkit-mask-image:linear-gradient(to_bottom,#000_0%,#000_45%,transparent_100%)] [mask-image:linear-gradient(to_bottom,#000_0%,#000_45%,transparent_100%)]"
        aria-hidden="true"
      >
        <motion.div
