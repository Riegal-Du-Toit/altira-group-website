  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[24px] bg-[#1E2021] font-sans">
      <div className="aspect-[2/1] w-full md:aspect-[2.5/1] lg:aspect-[2/1]">
        <div
          className="pointer-events-none absolute inset-0 select-none [mask-image:linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)] [&>svg]:h-full [&>svg]:w-full [&>svg]:bg-transparent"
                    ...
                    >
                      ...
                      >
                        <div className="flex h-full items-center justify-center">
                          <span
                            className={`${labelClassName} rounded-md border border-white/12 bg-[#252729]/95 px-2 py-0.5 font-medium text-white shadow-[0_8px_20px_rgba(0,0,0,0.24)]`}
                          >
                            {dot.start.label}
                          </span>
                        </div>
