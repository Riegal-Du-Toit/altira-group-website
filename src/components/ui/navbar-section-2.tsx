  ...
  return (
    <div className="relative z-30 w-full select-none font-sans">
      <div className="relative mx-auto hidden h-12 w-full max-w-7xl items-center justify-between lg:flex">
        <Link href="/homev2" className="flex items-center"><Image src="/logo.png" alt="Altira Group" width={218} height={72} className="h-auto w-[11.5rem]" priority /></Link>
      ...
      <div className="flex h-14 items-center justify-between lg:hidden">
        <Link href="/homev2"><Image src="/logo.png" alt="Altira Group" width={218} height={72} className="h-auto w-36" priority /></Link>
