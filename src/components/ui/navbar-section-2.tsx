  ...
  return (
    <div className="relative z-30 w-full select-none font-sans">
      <div className="relative mx-auto hidden h-12 w-full max-w-7xl items-center justify-between lg:flex">
        <Link href="#home" className={`flex items-center transition-all duration-300 ${hideLogo ? "pointer-events-none -translate-y-4 opacity-0" : "translate-y-0 opacity-100"}`}><Image src="/logo.png" alt="Altira Group" width={218} height={72} className="h-auto w-[11.5rem]" priority /></Link>
      ...
      <div className="flex h-14 items-center justify-between lg:hidden">
        <Link href="#home" className={`transition-all duration-300 ${hideLogo ? "pointer-events-none -translate-y-4 opacity-0" : "translate-y-0 opacity-100"}`}><Image src="/logo.png" alt="Altira Group" width={218} height={72} className="h-auto w-36" priority /></Link>
