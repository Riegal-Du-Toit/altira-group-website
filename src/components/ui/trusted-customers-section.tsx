...
import { FooterSocialIconRow } from "@/components/FooterSocials";
...
const partners = [
  ...
  { title: "Stripe", icon: "/partner-icons/stripe.svg", hideTitle: true, iconClassName: "!size-[4.8rem]" },
...
export default function TrustedCustomersSection() {
  return (
    <section id="trusted-customers" data-anchor-scroll-offset="48" className="overflow-hidden pb-16 pt-8 text-[#102d50] sm:pb-20 sm:pt-10" style={{ backgroundColor: "#F7F8FA" }}>
      ...
      <RulerCarousel originalItems={customerCarouselItems} subheading="Trusted by our customers" />

      <div className="mt-5 px-4 py-5 sm:px-6" style={{ backgroundColor: "#F7F8FA" }}>
