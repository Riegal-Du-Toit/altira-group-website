...
export function FloatingConsultButton({
  ...
  imageAlt = "Altira consultant",
  revolvingText = "START A CONVERSATION - ALTIRA GROUP - ",
  revolvingSpeed = 10,
  popupHeading = "30-minute call",
  popupDescription = "Speak with Altira about distribution, underwriting or partnership opportunities and we will determine the right next step together.",
  popupBadgeText = "Free",
